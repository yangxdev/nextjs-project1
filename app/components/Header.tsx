...
import logoDark from '../../cardinal-assets/cardinal-logo-inverted.svg';
import logoLight from '../../cardinal-assets/cardinal-logo.svg';
...
const Header = () => {
    ...
    return (
        <header className='flex justify-between'>
            <Image className='cursor-pointer hover:scale-110 transform transition-transform duration-300' draggable={false} src={!darkMode ? logoDark : logoLight} alt="Cardinal Logo" width="24" />
